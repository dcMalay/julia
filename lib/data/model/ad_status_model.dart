class AdStatus {
  AdStatus({
    required this.markedAsSold,
  });

  MarkedAsSold markedAsSold;

  factory AdStatus.fromJson(Map<String, dynamic> json) => AdStatus(
        markedAsSold: MarkedAsSold.fromJson(json["Marked as sold"]),
      );

  Map<String, dynamic> toJson() => {
        "Marked as sold": markedAsSold.toJson(),
      };
}
...
class MarkedAsSold {
  ...
  factory MarkedAsSold.fromJson(Map<String, dynamic> json) => MarkedAsSold(
        id: json["_id"],
